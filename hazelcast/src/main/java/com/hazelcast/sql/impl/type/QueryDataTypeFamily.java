...
public enum QueryDataTypeFamily {
    ...
    INTERVAL_YEAR_MONTH(true, TYPE_INTERVAL_YEAR_MONTH, PRECEDENCE_INTERVAL_YEAR_MONTH),
    INTERVAL_DAY_SECOND(true, TYPE_INTERVAL_DAY_SECOND, PRECEDENCE_INTERVAL_DAY_SECOND),
