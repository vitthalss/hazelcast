...
import com.hazelcast.sql.impl.exec.MapScanExecIterator;
...
public enum CompilerExecVariableType {
    ...
    MAP_SCAN_KEY_DESCRIPTOR(SqlTopObjectDescriptor.class),
    MAP_SCAN_VALUE_DESCRIPTOR(SqlTopObjectDescriptor.class),
